...
namespace util {
    ...
    namespace detail {
        ...
        public:
            ...
            inline ptr_wrapper_base() : m_ptr() { }

            inline ptr_wrapper_base( const W &ptr ) : m_ptr(ptr) { }

            inline ptr_wrapper_base<W> &operator=( const W &ptr ) { m_ptr = ptr; return *this; }
            ...
            inline bool operator==( const element_type &o ) const { return ref() == o; }
    ...
    public:
        ...
        inline ptr_wrapper() : detail::ptr_wrapper_base<W>() { }

        inline ptr_wrapper( element_type* p ) : detail::ptr_wrapper_base<W>(W(p)) { }

        inline ptr_wrapper( const W &ptr ) : detail::ptr_wrapper_base<W>(ptr) { }

        inline ptr_wrapper<W> &operator=( element_type *p ) { this->m_ptr = p; return *this; }
    ...
    public:
        ...
        inline ptr_wrapper( W *p ) : detail::ptr_wrapper_base<W*>(p) { }
    };
