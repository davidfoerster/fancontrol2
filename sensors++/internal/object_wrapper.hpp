...
template <typename T, typename ParentT = void>
class object_wrapper_numbered: public object_wrapper<T, ParentT>
{
public:
...
template <typename T, typename P>
bool object_wrapper<T,P>::empty() const
{
	return !m_object;
}
...
template <typename T, typename P>
bool object_wrapper<T,P>::operator!() const
{
	return empty();
}
...
template <typename T, typename P>
const T *object_wrapper<T,P>::get() const
{
	return m_object;
}
...
template <typename T, typename P>
const T *object_wrapper<T,P>::operator->() const
{
	return get();
}
...
template <typename T, typename P>
const shared_ptr<P> &object_wrapper<T,P>::parent() const
{
	return m_parent;
}
...
template <typename T, typename P>
bool object_wrapper<T,P>::has_parent() const
{
	return m_parent;
}

template <typename T, typename P>
object_wrapper<T,P>::object_wrapper()
	: m_object(0)
	, m_parent()
{
}
...
template <typename T, typename P>
object_wrapper<T,P>::object_wrapper(basic_type *object)
	: m_object(object)
{
}
...
template <typename T, typename P>
object_wrapper<T,P>::object_wrapper(basic_type *object, const shared_ptr<parent_type> &parent)
	: m_object(object)
	, m_parent(parent)
{
}
...
template <typename T, typename P>
bool object_wrapper_numbered<T,P>::number_comparator::equal(const basic_type *a, const basic_type *b)
{
	return (a && b) ? a->number == b->number : a == b;
}

template <typename T, typename P>
bool object_wrapper_numbered<T,P>::number_comparator::equal(const this_type &a, const basic_type *b)
{
	return equal(a.get(), b);
}

template <typename T, typename P>
bool object_wrapper_numbered<T,P>::number_comparator::equal(const this_type &a, const this_type &b)
{
...
template <typename T, typename P>
bool object_wrapper_numbered<T,P>::number_comparator::less(const basic_type *a, const basic_type *b)
{
	return (a && b) ? a->number < b->number : a < b;
}

template <typename T, typename P>
bool object_wrapper_numbered<T,P>::number_comparator::less(const this_type &a, const basic_type *b)
{
	return less(a.get(), b);
}

template <typename T, typename P>
bool object_wrapper_numbered<T,P>::number_comparator::less(const this_type &a, const this_type &b)
{
...
template <typename T, typename P>
bool object_wrapper_numbered<T,P>::operator==(const object_wrapper_numbered<T,P> &o) const
{
...
bool object_wrapper_numbered<T,P>::operator<(const object_wrapper_numbered<T,P> &o) const
{
	return super::parent_comparator::equal(*this, o) ?
			number_comparator::less(*this, o) :
			super::parent_comparator::less(*this, o);
}


template <typename T, typename P>
object_wrapper_numbered<T,P>::object_wrapper_numbered()
	: super()
{
}
...
template <typename T, typename P>
object_wrapper_numbered<T,P>::object_wrapper_numbered(basic_type *object)
	: super(object)
{
}
...
template <typename T, typename P>
object_wrapper_numbered<T,P>::object_wrapper_numbered(basic_type *object, const shared_ptr<parent_type> &parent)
	: super(object, parent)
{
}
